...
export function resolveRoute(path) {
  ...
  if (parts.length === 3 && parts[2] === 'gold-prices') {
    ...
    return { type: ROUTE_TYPES.CITY_PRICES, country: parts[0], city: parts[1], countryObj, cityObj };
  }
  ...
  if (parts.length === 4 && parts[2] === 'gold-rate') {
    ...
    return { type: ROUTE_TYPES.CITY_KARAT, country: parts[0], city: parts[1], karat: karatSlug, karatCode, countryObj, cityObj, karatObj };
  }
