...
| Learn-guide structured data + answer blocks (SEO/AEO)    | `cowork/nightly-2026-07-10`                   | in-progress | —   | Per-language Article JSON-LD from learn model + factual answer-summary block; HowTo N/A (no step content), FAQPage already via microdata (no dup) |
...
| 2026-07-07 | Claude Code | Phase 44 done (#581 src/branding/brand-config.js WHITE_LABEL_ENABLED=false spike; real brand + 2 demo skins; resolveBrandKey inert while off; --brand-_ namespace not live --color-_; scope guard asserts no tenant/billing; +6 tests; branched off main). Phase 45 (decision brief, docs-only) in-progress.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
