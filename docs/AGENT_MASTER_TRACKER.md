...
| 37              | Hindi localization foundation                                  | not-started         | **$0, non-gated** — reuse `*-pilot.js` infra               |
...
**Only genuinely-unstarted, $0, non-gated cowork item:** Phase 37 Hindi (`hi`, LTR) localization
pilot — reuses the proven-additive locale registry (`src/i18n/*-pilot.js`, `withXPilot()`, EN
fallback, parity tests) already shipped for FR/UR. Logged for next wave; not force-shipped to avoid
deepening the 19-PR unmerged backlog.
