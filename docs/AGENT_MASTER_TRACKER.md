...
| Program G / G3 — View Transition abort + console stability | `claude/g3-motion-guard-bsa6kk`               | done        | —   | Fully guard VT promise aborts (ready/finished/updateCallbackDone), idempotent binding, reduced-motion re-check, try/catch fallback nav, dev-only rejection beacon |
