...
| Program G / G6 — WCAG 2.2 tap-target size pass           | `claude/g6-tap-targets-k2tv7v`                | in-progress | [#619](https://github.com/vctb12/GoldTickerLive/pull/619) | CSS-only ≥24px targets (home/compare/shops/learn); no overflow 360/390/414 EN+AR; RTL safe |
