...
| `src/services/goldPriceService.js` | Server-side gold spot fetcher (reads committed `data/gold_price.json`)                | `scripts/python/fetch_gold_price.py`, provider adapters                      | Change server-side provider chain           |
