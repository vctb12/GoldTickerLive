...
> Update this file at the **start** and **end** of every session. One row per branch/PR. Master
> program:
...
2. Read
   [`docs/plans/2026-06-01_master-operations-hub.md`](../plans/2026-06-01_master-operations-hub.md)
   priority table
3. Use an **endless** prompt, e.g. `@.github/prompts/endless-integration-wiring.prompt.md`, or a
   Track B session from the program doc
