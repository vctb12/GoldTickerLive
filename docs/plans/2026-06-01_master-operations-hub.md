...
>   This hub remains a **one-screen routing summary**; playbooks, API map, CI catalog, and
>   step-by-step guides live in the workbook appendices.
...
| [`prompts/master-rerun.md`](../../prompts/master-rerun.md)                                                    | **Session bootstrap** — paste at start of every Claude/Cursor run     |
| [`docs/REPOS_TO_STEAL_FROM.md`](../REPOS_TO_STEAL_FROM.md)                                                    | External repo catalog (use / fork / study)                            |
| [`docs/plans/2026-06-09_github-control-center-setup.md`](./2026-06-09_github-control-center-setup.md)         | GitHub Actions + issue templates + control-center map                 |
...
Full copy-paste bodies:
[`2026-06-01_endless-session-prompts.md`](./2026-06-01_endless-session-prompts.md).
...
**Next from same program:** Tracks **B** (visual), **C** (repo), **D** (integration), **E**
(growth/AI) in
