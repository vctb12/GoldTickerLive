...
|     6 | ✅     | `cursor/20-phase-design-page-cleanup-revamp-db3b`    | `check-sitemap-parity.js` (warn-only; content gaps tracked for T3.2)                                                                                                                                  |
|     7 | ✅     | `cursor/20-phase-design-page-cleanup-revamp-db3b`    | Prior `CANDIDATES.md` retained; Phase 10 CSS report added                                                                                                                                             |
|     8 | ⬜     | —                                                    | No confirmed orphan removals this session (Bucket B needs per-file review)                                                                                                                            |
|     9 | ⬜     | —                                                    |                                                                                                                                                                                                       |
...
|    18 | ✅     | `cursor/20-phase-design-page-cleanup-revamp-db3b`    | `patchHeroLiveTick` + `patchHeroStatValues` partial hero path                                                                                                                                         |
