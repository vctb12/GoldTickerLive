...
This document lists every GitHub Secret the @GoldTickerLive posting system requires.
**No actual secret values are stored here — only names and descriptions.**
...
All four are required for posting tweets. Generated in the [X Developer Portal](https://developer.twitter.com).
...
> **Important:** Access Tokens must be generated under **Read and Write** permissions.
