...
- Leaf pages (country/city/karat/shops) are excluded from Vite build and copied as-is by deploy workflow
...
**Total raw CSS**: ~368K
**Potential issues**: No shared component CSS system — each page file may duplicate base component styles (buttons, cards, forms).
