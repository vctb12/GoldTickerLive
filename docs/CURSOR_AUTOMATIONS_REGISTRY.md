...
> **Living record** of Cloud Automations you configure at [cursor.com/automations](https://cursor.com/automations).
> Update this file after each automation is created, tuned, or upgraded. Agents read this to know
> current modes and avoid duplicate work.
