...
> Canonical plan: [`docs/plans/2026-06-09_platform-upgrade-program.md`](../docs/plans/2026-06-09_platform-upgrade-program.md)
...
- Do not change `post_gold.yml`, `gold-price-fetch.yml`, `data/gold_price.json`, `sw.js`, `constants.js` without owner approval.
