...
Gold Ticker Live is a bilingual (English / Arabic) gold price tracking platform for GCC and Arab
markets. It is a **static, multi-page website** built with vanilla HTML, CSS, and ES6 JavaScript
modules — no framework, no bundler at dev time. The production build is generated by Vite and
