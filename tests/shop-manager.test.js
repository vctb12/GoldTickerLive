...
describe('createShop', () => {
    test('creates a valid shop', () => {
        const result = shopManager.createShop(
            { name: 'Gold Palace', city: 'Dubai', country: 'UAE', phone: '+971501234567', website: 'https://goldpalace.ae' },
...
describe('updateShop', () => {
    test('updates allowed fields', () => {
        const created = shopManager.createShop({ name: 'UpdateMe', city: 'Dubai' }, 'admin@goldprices.com');
        const result = shopManager.updateShop(created.shop.id, { city: 'Sharjah', phone: '+971501111111' }, 'admin@goldprices.com');
        assert.equal(result.success, true);
    ...
    test('recalculates confidence after update', () => {
        ...
        const updated = shopManager.updateShop(
            created.shop.id,
            { phone: '+97150000000', website: 'https://test.com', address: '123 Gold St', hours: '9am-9pm' },
            'admin@goldprices.com'
        );
...
describe('getFilteredShops', () => {
    before(() => {
        ...
        shopManager.createShop({ name: 'Beta Jewels', city: 'Riyadh', country: 'Saudi Arabia' }, 'seed');
        shopManager.createShop({ name: 'Gamma Exchange', city: 'Dubai', country: 'UAE', verified: true }, 'seed');
    });
