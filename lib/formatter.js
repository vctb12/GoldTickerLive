const CURRENCY_SYMBOLS = {
  USD: '$', AED: 'د.إ', SAR: 'ر.س', KWD: 'د.ك', QAR: 'ر.ق', BHD: '.د.ب', OMR: 'ر.ع',
  JOD: 'د.أ', LBP: 'ل.ل', SYP: 'ل.س', ILS: '₪',
  EGP: 'ج.م', LYD: 'د.ل', TND: 'د.ت', DZD: 'دج', MAD: 'د.م',
  SDG: 'ج.س', SOS: 'Sh', MRU: 'أ.م', DJF: 'Fdj', KMF: 'CF',
  GBP: '£', EUR: '€', INR: '₹',
};
...
export function formatFreshness(updatedAt) {
  ...
  if (ageMins < 60)  return { label: `Updated ${Math.floor(ageMins)} min ago`, state: 'stale', ageMs };
  const timeStr = new Date(updatedAt).toLocaleTimeString('en-AE', { hour: '2-digit', minute: '2-digit', hour12: true, timeZone: 'Asia/Dubai' });
