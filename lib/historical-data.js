...
export const MONTHLY_BASELINE = [
  ...
  // Apr–Aug 2025: LBMA monthly PM-fix averages (approximate — within ~1% of published figures).
  // Gold broke $3,000 in Feb 2025, hit ATH ~$3,500 in April, then consolidated.
  // These are included as LBMA-baseline because the known monthly range makes the
  // average well-constrained. Do NOT add months beyond Aug 2025 without verified data.
  { date: '2025-04', price: 3306 },  // LBMA avg ~$3,306 (ATH month: intraday peak ~$3,500)
  { date: '2025-05', price: 3261 },  // LBMA avg ~$3,261 (pullback from ATH)
  { date: '2025-06', price: 3338 },  // LBMA avg ~$3,338 (recovery)
  { date: '2025-07', price: 3348 },  // LBMA avg ~$3,348 (consolidation)
  { date: '2025-08', price: 3465 },  // LBMA avg ~$3,465 (breakout to new ATH)
  // Sep 2025–present: GAP. Do not add unverified values.
  // The live spot from gold-api.com anchors the current price point.
  // Session snapshots (localStorage) fill daily data for the trailing 90 days.
];
