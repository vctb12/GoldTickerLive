...
export const MONTHLY_BASELINE = [
  ...
  // NOTE: Baseline ends here. Data for 2025-04 onwards needs verified LBMA monthly
  // averages before being added. Do NOT add estimated/projected values — they will
  // be surfaced in the chart and exports as if they are real historical data.
  // The live spot price from the API fills the "current" anchor; the gap between
  // the last baseline month and today will show only live/cached session snapshots.
];
