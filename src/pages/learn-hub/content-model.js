export const LEARN_CONTENT = Object.freeze({
  en: Object.freeze({
  ...
  ar: Object.freeze({
    ...
    'callout-spot-body':
      'نجلب سعر XAU/USD من gold-api.com كل ساعة أثناء ساعات السوق (ويُحفظ في المستودع كـ data/gold_price.json). أسعار الصرف من open.er-api.com. جميع الأسعار تقديرية للمرجعية — وليست للتنفيذ التجاري.',
