  ...
  en: {
    ...
    groups: [
      ...
      },
      {
        key: 'buy',
        label: 'Buy Gold',
        description: 'Buyer guides, premiums, making charges & submissions',
        layout: 'two-col',
        items: [
          {
            href: '/content/uae-gold-buying-guide/',
            label: 'UAE Buying Guide',
            description: 'Shop with AED context',
            icon: '🇦🇪',
            primary: true,
          },
          {
            href: '/content/dubai-gold-rate-guide/',
            label: 'Dubai Gold Guide',
            description: 'Rates, souks & charges',
            icon: '🏙️',
          },
          {
            href: '/content/gold-making-charges-guide/',
            label: 'Making Charges',
            description: 'Understand jewellery fees',
            icon: '🔨',
          },
          {
          ...
          },
          {
            ...
            label: '22K Price Guide',
            description: 'GCC jewellery baseline',
            icon: '💍',
          },
          {
            href: '/content/24k-gold-price-guide/',
            label: '24K Price Guide',
            description: 'Pure gold & bullion',
            icon: '🏅',
          },
          {
            href: '/content/submit-shop/',
            label: 'Submit a Shop',
            description: 'Send a listing for review',
            icon: '🏪',
          },
        ],
      },
      {
        key: 'markets',
        label: 'Markets',
        description: 'GCC country pages and regional comparison guides',
        layout: 'two-col',
        items: [
          {
            href: '/content/gcc-gold-price-comparison/',
            label: 'GCC Comparison Guide',
  ...
  ar: {
    ...
    groups: [
      ...
      },
      {
        key: 'buy',
        label: 'شراء الذهب',
        description: 'أدلة الشراء والعلاوات والمصنعية وإضافة المحلات',
        layout: 'two-col',
        items: [
          {
            href: '/content/uae-gold-buying-guide/',
            label: 'دليل شراء الذهب في الإمارات',
            description: 'اشترِ مع فهم سعر الدرهم',
            icon: '🇦🇪',
            primary: true,
          },
          {
            href: '/content/dubai-gold-rate-guide/',
            label: 'دليل ذهب دبي',
            description: 'الأسعار والأسواق والمصنعية',
            icon: '🏙️',
          },
          {
            href: '/content/gold-making-charges-guide/',
            label: 'دليل المصنعية',
            description: 'افهم رسوم المجوهرات',
            icon: '🔨',
          },
          {
            href: '/content/spot-vs-retail-gold-price/',
          ...
          {
            href: '/content/22k-gold-price-guide/',
            label: 'دليل سعر 22 قيراط',
            description: 'مرجع مجوهرات الخليج',
            icon: '💍',
          },
          {
            href: '/content/24k-gold-price-guide/',
            label: 'دليل سعر 24 قيراط',
          ...
          },
          {
            href: '/content/submit-shop/',
            label: 'أضف محلاً',
            description: 'أرسل listing للمراجعة',
            icon: '🏪',
          },
        ],
      },
      {
        key: 'markets',
        label: 'الأسواق',
        description: 'صفحات دول الخليج وأدلة المقارنة الإقليمية',
        layout: 'two-col',
        items: [
          {
            href: '/content/gcc-gold-price-comparison/',
            label: 'دليل مقارنة الخليج',
