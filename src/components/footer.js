import { DATA_ATTRIBUTION, getKaratCountLabel, getRefreshStatement } from '../config/index.js';
    ...
    <div class="footer-inner">
      ...
      <div class="footer-col footer-col--brand">
        ...
        <div class="footer-brand-badges">
          <span class="footer-badge">${isAr ? 'أسواق 26 دولة' : '26 Markets Compared'}</span>
