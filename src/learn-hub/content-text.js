/**
 * Learn-hub localized copy (the article text corpus) + text resolvers.
 *
 * Split from the article structure on purpose: the English learn.html fast
 * path enhances prerendered static HTML and never renders this copy, so this
 * module must only be reachable through the lazily imported article renderer
 * (see src/pages/learn.js). Do not import it from any module in the eager
 * learn.html graph.
 */
