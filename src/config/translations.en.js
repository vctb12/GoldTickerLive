...
export const EN = {
  ...
  'tracker.metalChart.kicker': 'Local pilot',
  ...
  'tracker.metalChart.currentOnly':
    'Current reference quote only · historical coverage unavailable.',
  'tracker.metalChart.currentOnlyShort': 'current reference quote only',
  'tracker.metalChart.source': 'Source: {source}',
  'tracker.metalChart.freshness': 'State: {state}',
  'tracker.metalChart.timestamp': 'Provider time: {timestamp}',
  'tracker.metalChart.loading': 'Loading current reference quote…',
  'tracker.metalChart.unavailable': 'Current reference quote unavailable.',
  ...
  'home.uaeHistKicker': 'UAE Market History',
  'home.uaeHistTitle': 'UAE Historical Gold Rate Chart (AED/g)',
  'home.uaeHistSub':
    'Daily average spot-linked reference prices in AED per gram for 24K, 22K, 21K, and 18K. Not retail shop quotes.',
  ...
  'home.uaeHist.range3M': '3M',
  'home.uaeHist.range6M': '6M',
  'home.uaeHist.range12M': '12M',
  'home.uaeHist.modeLine': 'Line chart',
  'home.uaeHist.modeArea': 'Area chart',
  'home.uaeHist.legendLabel': 'Karat series',
  'home.uaeHist.karat24': '24 Carat',
  'home.uaeHist.karat22': '22 Carat',
  'home.uaeHist.karat21': '21 Carat',
  'home.uaeHist.karat18': '18 Carat',
  'home.uaeHist.showAllSeries': 'Show all',
  'home.uaeHist.dataCoverage': 'Data coverage: {start} – {end}',
  'home.uaeHist.rangeSubtitle1M': '1-month window ending {endDate}',
  'home.uaeHist.rangeSubtitle3M': '3-month window ending {endDate}',
  ...
  'home.uaeHist.freshness.unavailable': 'Historical data unavailable',
  'home.uaeHist.resolution.daily_average_reference': 'Daily average spot-linked reference',
  'home.uaeHist.resolution.daily_reference': 'Daily average spot-linked reference',
  'home.uaeHist.resolution.mixed_daily_monthly': 'Mixed daily and monthly observations',
  'home.uaeHist.resolution.monthly_baseline': 'Monthly baseline',
  'home.uaeHist.resolution.cached_browser': 'Cached browser observations',
  'home.uaeHist.resolution.unavailable': 'Historical data unavailable',
  'home.uaeHist.summaryLatest': 'Latest available daily average 24K',
  'home.uaeHist.summaryChange': 'Period change',
  'home.uaeHist.summaryHigh': 'Period high',
  'home.uaeHist.summaryLow': 'Period low',
  'home.uaeHist.tableCaption': 'UAE historical reference gold prices by karat',
  'home.uaeHist.colDate': 'Date',
  'home.uaeHist.tableShowMore': 'Show more rows',
  'home.uaeHist.tableCollapse': 'Collapse table',
  'home.uaeHist.exportCsv': 'Export CSV',
  'home.uaeHist.retry': 'Retry',
  'home.uaeHist.noData': 'Historical reference data is unavailable for this range.',
  ...
  'dealChecker.breadcrumb': 'Deal Intelligence Lab',
  'dealChecker.eyebrow': 'Buyer tool',
  'dealChecker.title': 'Check a gold quote with the numbers in front of you',
  'dealChecker.subtitle':
    'Separate fine-gold value from making charges, premiums, tax, and the seller quote. This is a reference comparison, not a retail verdict.',
  'dealChecker.referenceNote':
    'Reference estimate only. A shop quote may include design, labour, tax, negotiation, and other local adjustments.',
  'dealChecker.formTitle': 'Enter the quote details',
  'dealChecker.formIntro':
    'Unknown charges remain unknown in the model. Add the line items from the invoice when you have them.',
  'dealChecker.currency': 'Quote currency',
  'dealChecker.purchaseType': 'Purchase type',
  'dealChecker.purchaseJewelry': 'Jewellery',
  'dealChecker.purchaseBullion': 'Bar or coin',
  'dealChecker.purchaseScrap': 'Scrap or resale quote',
  'dealChecker.quotedTotal': 'Quoted total',
  'dealChecker.grossWeight': 'Gross weight (g)',
  'dealChecker.nonGoldWeight': 'Stone / non-gold weight (g)',
  'dealChecker.karat': 'Karat',
  'dealChecker.making': 'Making charge',
  'dealChecker.makingUnknown': 'Not provided',
  'dealChecker.makingPerGram': 'Per chargeable gram',
  'dealChecker.makingFixed': 'Fixed amount',
  'dealChecker.makingPercent': 'Percentage of reference value',
  'dealChecker.makingIncluded': 'Included in quote / no separate line',
  'dealChecker.premium': 'Design or seller premium',
  'dealChecker.premiumUnknown': 'Not provided',
  'dealChecker.premiumPercent': 'Percentage of reference value',
  'dealChecker.premiumFixed': 'Fixed amount',
  'dealChecker.premiumIncluded': 'Included in quote / no separate line',
  'dealChecker.tax': 'VAT or tax',
  'dealChecker.taxUnknown': 'Not provided',
  'dealChecker.taxPercent': 'Percentage of subtotal',
  'dealChecker.taxIncluded': 'Included in quote / no separate line',
  'dealChecker.discount': 'Discount',
  'dealChecker.discountNone': 'None',
  'dealChecker.discountPercent': 'Percentage of subtotal',
  'dealChecker.discountFixed': 'Fixed amount',
  'dealChecker.componentValue': 'Amount or percentage',
  ...
  'dealChecker.referencePerGross': 'Reference per gross gram',
  'dealChecker.quotedPerGross': 'Quoted per gross gram',
  'dealChecker.makingTotal': 'Making charge',
  'dealChecker.premiumTotal': 'Design or seller premium',
  'dealChecker.taxTotal': 'VAT or tax',
  'dealChecker.discountTotal': 'Discount',
  'dealChecker.modeledTotal': 'Modeled disclosed total',
  'dealChecker.residual': 'Unexplained residual',
  'dealChecker.markup': 'Quote minus reference value',
  'dealChecker.markupPct': 'Quote premium over reference',
  'dealChecker.markupPerGross': 'Markup per gross gram',
  'dealChecker.actualGoldShare': 'Reference value share of quote',
  'dealChecker.breakEven': 'Break-even spot price',
  'dealChecker.resaleEstimate': 'Simple resale estimate',
  'dealChecker.resaleGap': 'Quote minus resale estimate',
  'dealChecker.benchmark': 'Configured benchmark comparison',
  'dealChecker.statusIncomplete': 'Incomplete disclosure',
  ...
  'dealChecker.export': 'Export JSON',
  'dealChecker.print': 'Print comparison',
  'dealChecker.exported': 'Export prepared',
  'dealChecker.languageNote': 'Switching language keeps the comparison inputs on this device.',
  'dealChecker.quoteRequired': 'Enter a quoted total greater than zero.',
  'dealChecker.weightRequired': 'Enter a gross weight greater than zero.',
  'dealChecker.nonGoldInvalid': 'Non-gold weight must be lower than gross weight.',
  'dealChecker.karatInvalid': 'Select a supported karat.',
  'dealChecker.numberInvalid': 'Use a number greater than or equal to zero.',
  'dealChecker.tryAgain': 'Retry snapshot',
  'dealChecker.methodologyLink': 'Read the full methodology',
  'dealChecker.learnLink': 'Read the buying guide',
  'dealChecker.trackerLink': 'Open the live tracker',
};
