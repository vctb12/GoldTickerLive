...
export const EN = {
  ...
  'home.uaeHistSub':
    'Spot-linked reference history derived from historical XAU/USD, the fixed AED peg (3.6725), and karat purity. Retail shop prices may include making charges, dealer premiums, and VAT.',
  'home.uaeHistMethodology': 'How we calculate reference prices',
  'home.uaeHistTrackerLink': 'Open full tracker',
  'home.uaeHist.badge': 'Spot-linked reference',
  'home.uaeHist.sourceNote': 'Reference estimate · derived from XAU/USD spot history',
  ...
  'home.uaeHist.freshness.current': 'Current historical coverage',
  'home.uaeHist.freshness.delayed': 'Delayed historical coverage · ends {date}',
  'home.uaeHist.freshness.stale': 'Stale historical coverage · ends {date}',
  'home.uaeHist.freshness.unavailable': 'Historical data unavailable',
  'home.uaeHist.resolution.daily_reference': 'Daily reference observations',
  ...
  'home.uaeHist.summaryLatest': 'Latest historical 24K',
