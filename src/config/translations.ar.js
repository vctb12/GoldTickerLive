...
export const AR = {
  ...
  'home.uaeHistSub':
    'سجل مرجعي مرتبط بالسعر الفوري، مشتق من XAU/USD التاريخي، وربط الدرهم الثابت (3.6725)، ونقاوة العيار. قد تتضمن أسعار المحلات أجور الصياغة وهوامش التاجر وضريبة القيمة المضافة.',
  'home.uaeHistMethodology': 'كيف نحسب الأسعار المرجعية',
  'home.uaeHistTrackerLink': 'افتح المتتبع الكامل',
  'home.uaeHist.badge': 'مرجع مرتبط بالسعر الفوري',
  'home.uaeHist.sourceNote': 'تقدير مرجعي · مشتق من سجل XAU/USD',
  ...
  'home.uaeHist.freshness.current': 'تغطية تاريخية حالية',
  'home.uaeHist.freshness.delayed': 'تغطية تاريخية متأخرة · تنتهي {date}',
  'home.uaeHist.freshness.stale': 'تغطية تاريخية قديمة · تنتهي {date}',
  'home.uaeHist.freshness.unavailable': 'البيانات التاريخية غير متاحة',
  'home.uaeHist.resolution.daily_reference': 'ملاحظات مرجعية يومية',
  ...
  'home.uaeHist.summaryLatest': 'آخر سعر تاريخي 24K',
