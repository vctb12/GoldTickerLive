...
export const AR = {
  ...
  'tracker.metalChart.kicker': 'نسخة تجريبية محلية',
  ...
  'tracker.metalChart.currentOnly': 'سعر مرجعي حالي فقط · السجل التاريخي غير متاح.',
  'tracker.metalChart.currentOnlyShort': 'سعر مرجعي حالي فقط',
  'tracker.metalChart.source': 'المصدر: {source}',
  'tracker.metalChart.freshness': 'الحالة: {state}',
  'tracker.metalChart.timestamp': 'وقت المصدر: {timestamp}',
  'tracker.metalChart.loading': 'جارٍ تحميل السعر المرجعي الحالي…',
  'tracker.metalChart.unavailable': 'السعر المرجعي الحالي غير متاح.',
  ...
  'home.uaeHistKicker': 'تاريخ سوق الإمارات',
  'home.uaeHistTitle': 'سجل أسعار الذهب المرجعية في الإمارات (درهم/غرام)',
  'home.uaeHistSub':
    'متوسط يومي مرجعي مرتبط بالسعر الفوري لكل غرام بالدرهم لعيارات 24 و22 و21 و18. ليست أسعار محلات تجزئة.',
  ...
  'home.uaeHist.range3M': '3ش',
  'home.uaeHist.range6M': '6ش',
  'home.uaeHist.range12M': '12ش',
  'home.uaeHist.modeLine': 'مخطط خطي',
  'home.uaeHist.modeArea': 'مخطط مساحي',
  'home.uaeHist.legendLabel': 'سلاسل العيارات',
  'home.uaeHist.karat24': 'عيار 24',
  'home.uaeHist.karat22': 'عيار 22',
  'home.uaeHist.karat21': 'عيار 21',
  'home.uaeHist.karat18': 'عيار 18',
  'home.uaeHist.showAllSeries': 'إظهار الكل',
  'home.uaeHist.dataCoverage': 'نطاق البيانات: {start} – {end}',
  'home.uaeHist.rangeSubtitle1M': 'نافذة شهر واحد تنتهي في {endDate}',
  'home.uaeHist.rangeSubtitle3M': 'نافذة 3 أشهر تنتهي في {endDate}',
  'home.uaeHist.rangeSubtitle6M': 'نافذة 6 أشهر تنتهي في {endDate}',
  'home.uaeHist.rangeSubtitle12M': 'نافذة 12 شهرًا تنتهي في {endDate}',
  'home.uaeHist.coverageDelayed': 'التغطية التاريخية متأخرة حتى {date}',
  'home.uaeHist.importError': 'تعذّر تحميل المخطط التاريخي. تحقق من الاتصال وأعد المحاولة.',
  'home.uaeHist.freshness.current': 'سجل مرجعي يومي حالي',
  'home.uaeHist.freshness.delayed': 'سجل مرجعي يومي متأخر · ينتهي {date}',
  'home.uaeHist.freshness.stale': 'سجل مرجعي يومي قديم · ينتهي {date}',
  'home.uaeHist.freshness.unavailable': 'البيانات التاريخية غير متاحة',
  'home.uaeHist.resolution.daily_average_reference': 'متوسط يومي مرجعي مرتبط بالسعر الفوري',
  'home.uaeHist.resolution.daily_reference': 'متوسط يومي مرجعي مرتبط بالسعر الفوري',
  'home.uaeHist.resolution.mixed_daily_monthly': 'ملاحظات يومية وشهرية مختلطة',
  'home.uaeHist.resolution.monthly_baseline': 'خط أساس شهري',
  'home.uaeHist.resolution.cached_browser': 'ملاحظات مخزنة في المتصفح',
  'home.uaeHist.resolution.unavailable': 'البيانات التاريخية غير متاحة',
  'home.uaeHist.summaryLatest': 'آخر متوسط يومي متاح لعيار 24',
  'home.uaeHist.summaryChange': 'تغيّر الفترة',
  'home.uaeHist.summaryHigh': 'أعلى الفترة',
  'home.uaeHist.summaryLow': 'أدنى الفترة',
  'home.uaeHist.tableCaption': 'أسعار الذهب المرجعية التاريخية في الإمارات حسب العيار',
  'home.uaeHist.colDate': 'التاريخ',
  'home.uaeHist.tableShowMore': 'عرض المزيد من الصفوف',
  'home.uaeHist.tableCollapse': 'طي الجدول',
  'home.uaeHist.exportCsv': 'تصدير CSV',
  'home.uaeHist.retry': 'إعادة المحاولة',
  'home.uaeHist.noData': 'بيانات مرجعية تاريخية غير متاحة لهذه الفترة.',
  ...
  'home.faq1A': [
    ...
    ['./tracker.html', 'متتبع الذهب'],
    ' وفي ',
    ['./compare.html', 'مقارنة الدول'],
  ...
  'methodology.stepGram':
    'نحوّل أوقية تروي إلى غرام باستخدام ثابت 31.1034768 المعتمد (1 أوقية = 31.1034768 غ؛ 0.5 أوقية = 15.5517384 غ؛ 10 أوقيات = 311.034768 غ). نحافظ على دقة الحساب كاملة، ونقرّب فقط عند العرض إلى منزلتين عشريتين لتسهيل القراءة.',
  ...
  'methodology.formula': 'السعر_المحلي_للغرام = (XAU/USD ÷ 31.1034768) × معامل_العيار × سعر_الصرف',
  ...
  'locationGuides.sectionLink': 'قارن الدول ←',
  ...
  'dealChecker.purchaseBullion': 'سبيكة أو عملة',
  'dealChecker.purchaseScrap': 'خردة أو عرض إعادة بيع',
  'dealChecker.quotedTotal': 'إجمالي العرض',
  'dealChecker.grossWeight': 'الوزن الإجمالي (غ)',
  'dealChecker.nonGoldWeight': 'وزن الأحجار أو غير الذهب (غ)',
  'dealChecker.karat': 'العيار',
  'dealChecker.making': 'أجرة الصياغة',
  'dealChecker.makingUnknown': 'غير مذكورة',
  'dealChecker.makingPerGram': 'لكل غرام قابل للحساب',
  'dealChecker.makingFixed': 'مبلغ ثابت',
  'dealChecker.makingPercent': 'نسبة من القيمة المرجعية',
  'dealChecker.makingIncluded': 'مشمولة في العرض أو لا يوجد بند منفصل',
  'dealChecker.premium': 'علاوة التصميم أو البائع',
  'dealChecker.premiumUnknown': 'غير مذكورة',
  'dealChecker.premiumPercent': 'نسبة من القيمة المرجعية',
  'dealChecker.premiumFixed': 'مبلغ ثابت',
  'dealChecker.premiumIncluded': 'مشمولة في العرض أو لا يوجد بند منفصل',
  'dealChecker.tax': 'ضريبة القيمة المضافة أو الضريبة',
  'dealChecker.taxUnknown': 'غير مذكورة',
  'dealChecker.taxPercent': 'نسبة من المجموع الفرعي',
  'dealChecker.taxIncluded': 'مشمولة في العرض أو لا يوجد بند منفصل',
  'dealChecker.discount': 'الخصم',
  'dealChecker.discountNone': 'لا يوجد',
  'dealChecker.discountPercent': 'نسبة من المجموع الفرعي',
  'dealChecker.discountFixed': 'مبلغ ثابت',
  'dealChecker.componentValue': 'المبلغ أو النسبة',
  'dealChecker.buyback': 'نسبة إعادة البيع التقديرية (%)',
  'dealChecker.buybackHint': 'اختياري؛ تستخدم فقط لسيناريو إعادة بيع مبسط.',
  'dealChecker.tolerance': 'هامش المقارنة (%)',
  'dealChecker.toleranceHint': 'يستخدم فقط لوصف العرض بأنه دون أو ضمن أو فوق الهامش الذي ضبطته.',
  'dealChecker.shopLabel': 'اسم المحل أو العرض',
  'dealChecker.shopLabelHint': 'يحفظ محلياً على هذا الجهاز ولا يرسل إلى التحليلات.',
  'dealChecker.quoteTimestamp': 'تاريخ ووقت العرض',
  'dealChecker.optional': 'اختياري',
  ...
  'dealChecker.referencePerGross': 'القيمة المرجعية لكل غرام إجمالي',
  'dealChecker.quotedPerGross': 'العرض لكل غرام إجمالي',
  'dealChecker.makingTotal': 'أجرة الصياغة',
  'dealChecker.premiumTotal': 'علاوة التصميم أو البائع',
  'dealChecker.taxTotal': 'الضريبة',
  'dealChecker.discountTotal': 'الخصم',
  'dealChecker.modeledTotal': 'إجمالي البنود المحسوبة',
  'dealChecker.residual': 'المتبقي غير المفسر',
  'dealChecker.markup': 'العرض ناقص القيمة المرجعية',
  'dealChecker.markupPct': 'زيادة العرض على القيمة المرجعية',
  'dealChecker.markupPerGross': 'الزيادة لكل غرام إجمالي',
  'dealChecker.actualGoldShare': 'حصة القيمة المرجعية من العرض',
  'dealChecker.breakEven': 'سعر الذهب الفوري عند التعادل',
  'dealChecker.resaleEstimate': 'تقدير إعادة البيع المبسط',
  'dealChecker.resaleGap': 'العرض ناقص تقدير إعادة البيع',
  'dealChecker.benchmark': 'مقارنة الهامش الذي ضبطته',
  'dealChecker.statusIncomplete': 'الإفصاح غير مكتمل',
  ...
  'dealChecker.copyFailure': 'النسخ غير متاح؛ الرابط جاهز في شريط العنوان.',
  'dealChecker.export': 'تصدير JSON',
  'dealChecker.print': 'طباعة المقارنة',
  'dealChecker.exported': 'تم تجهيز التصدير',
  'dealChecker.languageNote': 'يحتفظ تبديل اللغة ببيانات المقارنة على هذا الجهاز.',
  'dealChecker.quoteRequired': 'أدخل إجمالي عرض أكبر من صفر.',
  'dealChecker.weightRequired': 'أدخل وزناً إجمالياً أكبر من صفر.',
  'dealChecker.nonGoldInvalid': 'يجب أن يكون وزن غير الذهب أقل من الوزن الإجمالي.',
  'dealChecker.karatInvalid': 'اختر عياراً مدعوماً.',
  'dealChecker.numberInvalid': 'استخدم رقماً أكبر من أو يساوي صفراً.',
  'dealChecker.tryAgain': 'إعادة محاولة اللقطة',
  'dealChecker.methodologyLink': 'اقرأ المنهجية كاملة',
  'dealChecker.learnLink': 'اقرأ دليل الشراء',
  'dealChecker.trackerLink': 'افتح المتتبع المباشر',
};
